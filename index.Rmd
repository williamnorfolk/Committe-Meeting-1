...
At a time where emerging pathogens are at the forefront of attention, a proper understanding of bacterial physiology is imperative to the successful managment of novel pathogenic species. The recent increases in _V. alginolyticus_ infection prevelance warrents further investingation into the bacterium to determine pathogenicity traits and adaptive mechannisms. Despite being one of the most abundant species of _Vibrio_, few studies have investigated the specific physiological characteristics of _V. alginolyticus_ and thus there is a needed for baseline level data on the bacterium. 

Laboratory observations (Lipp Lab) have indicated that certian strains of _V. alginolyticus_ secrete a thick mucoid extracellular polymeric substance (EPS) that we hypothesize may serve as an adaptive trait in the environment. It is unknown if these EPSs are survival-based, virulence indicators, or representative of another unkown trait of the bacterium. Characterization of these EPSs would provide baseline data on the physiological and adaptive responses of the bacterium in the envrionment. Furthermore, it is known that _Vibrio_ rapidly respond to increased nutrient availabilty in the environment exhibiting a "boom-bust cycle" of growth and decline. A chemical characterization of the microbial volitale organic compounds (MVOCs) produced during log phase growth of _V. alginolyticus_ would provide novel insight into the metabolic characteristics of the bacterium and could be used to compare metabolic differences at high vurses low nurient availability. 
...
#### Proposed Publications 
1. Chemical characterization of _V. alginolyticus_ extracellular polymeric substances and microbial volitale organic compounds.  
_The specific objectives of this proposed publication are subject to changed based on the results of preliminary investigaitons._ 
