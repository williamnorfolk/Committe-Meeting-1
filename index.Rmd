...
```{r artemia culture, fig.cap="Figure 4: Marine microcosms with hatching Artemia for the pilot Vibrio alginolyticus attachment study", fig.hold='hold', fig.align='center',echo=FALSE}
knitr::include_graphics("./artemia_culture.MOV")
```

The results of this study showed that culturable _Vibrio_ were recovered from homogenized _Artemia_ which suggests that _V. alginolyticus_ has the ability attach to _Artemia_ (Fig 5). Control cultures of unseeded _Artemia_ and seeded wash ASW (ASW used to remove any liquid suspended _Vibrio_) showed no bacterial growth indicating the homogenate-cultured _Vibrio_ was attached to the _Artemia_ included in the samples. 

```{r artemia, fig.cap="Figure 4: Vibrio alginolyticus attachment pilot study", fig.hold='hold', out.height = "100%", out.width = "100%", fig.show='hold', fig.align='center',echo=FALSE}
