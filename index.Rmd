...
In April I joined the Center for the Ecology of Infectious Diseases (CEID) coronavirus working group to assist with the development of data visualizations for the evolving COVID-19 pandemic (Fig 8). To date I have contributed to (and continue to update) the design and coding of the CEID COVID [COVID tracker](https://www.covid19.uga.edu/tracker.html). Currently I am working to develop a similar R-based shiny application for the visualization of forecast model data to be released in the near future following peer review. 
